<template>
    <div>
        <h2 :style="{ fontSize: '30px', marginLeft: '30px' }">Средства измерения</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Измерение заземлений</th>
                    <th>Измерение медного кабеля</th>
                    <th>Измерение оптического кабеля</th>
                    <th>Год выпуска</th>
                </tr>
            </thead>
