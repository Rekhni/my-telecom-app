<template>
    <div>
        <h2 :style="{ fontSize: '30px', marginLeft: '30px' }">Перенос сроков</h2>
        <div className="actions">
            ...
            <button className="btn-green">Одобрить заявку</button>
            <button className="btn-red">Отвергнуть заявку</button>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th>Идентификатор</th>
                    <th>Идентификатор плана</th>
                    <th>Статус</th>
                    <th>Отправитель</th>
                    <th>Класс работ</th>
                    <th>Новая дата окончания работ</th>
                    <th>Описание причины</th>
                </tr>
            </thead>
