<template>
    <div>
        <h2 :style="{ fontSize: '30px', marginLeft: '30px' }">Измерения герметичности кабеля</h2>
        <div className="actions">
            ...
            <button className="btn-green">Копия измерения</button>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Внесено измерений по N обьектам</th>
